...
/*
	...
	HTS_Engine_set_gv_weight(&engine, 0, 1.0);
	//HTS_Engine_set_gv_weight(&engine, 1, 6.25);
	//HTS_Engine_set_gv_weight(&engine, 2, 7.25); See ei mõju
	x = HTS_Engine_get_gv_weight(&engine, 0);
	printf("2.0- %f\n", x);
  */  
